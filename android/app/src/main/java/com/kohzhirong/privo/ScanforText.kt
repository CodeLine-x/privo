...
class ScanforText {
    companion object {
        ...
        /**
         * Detect text in an image and return only PII coordinates
         * This mimics the iOS implementation which filters for PII internally
         */
        fun detectText(
            bitmap: Bitmap,
            completion: (List<SensitiveCoordinate>) -> Unit
        ) {
            Log.d(TAG, "=== Starting text detection (PII filtered) ===")
            ...
            textRecognizer.process(inputImage)
                .addOnSuccessListener { visionText ->
                    ...
                    // Use PIIDetector to identify sensitive text (mimics iOS behavior)
                    ...
                    Log.d(TAG, "Total PII text elements found: ${piiCoordinates.size}")
        ...
        fun detectAllText(
            ...
            Log.d(TAG, "=== Starting all text detection ===")
            Log.d(TAG, "Bitmap dimensions: ${bitmap.width} x ${bitmap.height}")
